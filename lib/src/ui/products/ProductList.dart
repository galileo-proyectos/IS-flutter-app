        ...
        Flexible(
            ...
            child: Padding(
              ...
              child: SizedBox(
                ...
                child: TextField(
                  controller: Provider.of<ProviderProducts>(ctx, listen: false).nameFilter,
      ...
      Consumer<ProviderProducts>(builder: (ctx, provider, child) {
        if (provider.isLoading()) {
          ...
          return const Column(
              ...
              children: [Text("Loading...", style: MyStyles.h1), CircularProgressIndicator(color: MyStyles.orange)]);
        } else {
